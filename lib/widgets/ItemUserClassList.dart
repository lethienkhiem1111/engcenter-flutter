...
class ItemUserClassList extends StatelessWidget {
  final int idHocVien;
  final String image;
  final Class classDetail;

  ItemUserClassList(this.idHocVien, this.image, this.classDetail);
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.pushNamed(context, ClassUserTest.routeName, 
          arguments: ClassScreenArgument.studyingUser(idHocVien, classDetail.idLop));
        },
      ),
